...
$username = $password = $confirm_password = $photo = "";
$status = 1;
$admin = 0;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (username, password, status, admin, photo) VALUES (:username, :password, :status, :admin, :photo)";
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            $stmt->bindParam(":admin", $param_admin, PDO::PARAM_INT);
  ...
  <ul class="navbar-nav">
    <li class="logo">
      <a href="../index.html" class="nav-link">
        <span class="link-text logo-text">JMU DEV</span>
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fad"
    ...
    <li class="nav-item">
      <a href="../graphs.html" class="nav-link">
        ...
        <span class="link-text">Graphs</span>
      </a>
    </li>
